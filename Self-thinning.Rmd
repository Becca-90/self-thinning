...
1. The "self-thinning line" is obtained when we plot N, the number of individuals of each time point, per unit area, against mean S, their mean size (e.g. via their height or stem diameter). Scaling these axes by log10 produces a straight "thinning line".
