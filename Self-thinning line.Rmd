...
#use code in make hyperpar to plot tradeoffs
#LMA vs k_l
...
B_kl2: scaling slope for phi in leaf turnover
...
B_dI2: scaling slope for WD in intrinsic mortality

WD/wood turnover relationship:
k_s  <- B_ks1 *  (rho / rho_0) ^ (-B_ks2)
B_ks1: rate of sapwood turnover at rho_0
B_ks2: scaling slope for rho in sapwood turnover
...
B_lf5: scaling exponent for leaf nitrogen in maximum leaf photosynthesis
